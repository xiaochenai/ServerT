   ...
   public class IDACSCommon   
	{
      ...
      public static final int RETRNASMIT_NON_ACKED_SACKED_PACKETS_TIMER_DURATION = 50;	// retransmit non-ACK or -SACKed packets 5 milliseconds after last ACK/SACK packet is received
   	public static final int WAIT_FOR_FINAL_ACK_TIMER_DURATION = 20000;	// wait for final ACK on a packet or flight of packets for 20 seconds for each packet sent before retransmitting the entire flight
		public static final int MAX_RETRANSMIT_ATTEMPTS = 5;
